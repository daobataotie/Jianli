...
namespace Book.DA.SQLServer
{
    ...
    public partial class ProductUnitAccessor : EntityAccessor, IProductUnitAccessor
    {
        ...
        public Model.ProductUnit SelectByGroupIdAndName(string groupId, string name)
        {
            Hashtable ht = new Hashtable();
            ht.Add("UnitGroupId", groupId);
            ht.Add("CnName", name);
            return sqlmapper.QueryForObject<Model.ProductUnit>("ProductUnit.SelectByGroupIdAndName", ht);
        }
