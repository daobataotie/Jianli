...
namespace Book.DA.SQLServer
{
    ...
    public partial class PronoteHeaderAccessor : EntityAccessor, IPronoteHeaderAccessor
    {
        ...
        public string SelectXOIdByCondition(string productId, string pronoteHeaderId)
        {
            Hashtable ht = new Hashtable();
            ht.Add("ProductId", productId);
            ht.Add("PronoteHeaderID", pronoteHeaderId);

            return sqlmapper.QueryForObject<string>("PronoteHeader.SelectXOIdByCondition", ht);
        }
    }
}
