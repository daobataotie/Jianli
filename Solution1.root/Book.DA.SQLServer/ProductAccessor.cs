...
namespace Book.DA.SQLServer
{
    ...
    public partial class ProductAccessor : EntityAccessor, IProductAccessor
    {
        ...
        {
            return sqlmapper.QueryForList<Model.Product>("Product.SelectProductForXOByCustomer", customerId);
        }
        ...
        {
            return sqlmapper.QueryForObject<bool>("Product.ExistsId", id);
        }

        public bool BarCodeIsExists(string productBarCode)
        {
            return sqlmapper.QueryForObject<bool>("Product.BarCodeIsExists", productBarCode);
        }
        ...
        {
            return sqlmapper.QueryForList<Model.Product>("Product.SelectIdAndName", null);
        }
    }
}
