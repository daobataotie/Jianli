...
//----------------------------------------------------------------*/
    public partial class Q48 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public Q48(ConditionMPS condition)
        {
            ...
            this.xrTableXOId.DataBindings.Add("Text", this.DataSource, "InvoiceXO." + Model.InvoiceXO.PRO_CustomerInvoiceXOId);
            this.xrTablePaiDan.DataBindings.Add("Text", this.DataSource, Model.MPSdetails.PRO_MPSHasSingleSum);
