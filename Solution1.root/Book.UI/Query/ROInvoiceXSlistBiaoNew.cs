...
{
    public partial class ROInvoiceXSlistBiaoNew : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        {
            ROInvoiceXSlistBiaoNewSub sub = this.xrSubreport1.ReportSource as ROInvoiceXSlistBiaoNewSub;
