...
{
    public partial class R01ZYD : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public R01ZYD(string invoiceid)
        {
            InitializeComponent();
            ...
            this.xrLabelHeji.Text += global::Helper.DateTimeParse.GetSiSheWuRu(this.invoice.InvoiceHeji.Value, BL.V.SetDataFormat.CGZJXiao.Value).ToString("N");
            this.xrLabelTax.Text += global::Helper.DateTimeParse.GetSiSheWuRu(this.invoice.InvoiceTax.Value, BL.V.SetDataFormat.CGZJXiao.Value).ToString("N");
            this.xrLabelTatol.Text += global::Helper.DateTimeParse.GetSiSheWuRu(this.invoice.InvoiceTotal.Value, BL.V.SetDataFormat.CGZJXiao.Value).ToString("N");
            ...
            this.xrTablePrice.DataBindings.Add("Text", this.DataSource, Model.InvoiceCGDetail.PRO_InvoiceCGDetailPrice, "{0:N}");
            ...
            this.xrTableTaxPrice.DataBindings.Add("Text", this.DataSource, Model.InvoiceCGDetail.PRO_InvoiceCGDetailTaxPrice, "{0:N}");
            this.xrTableZR.DataBindings.Add("Text", this.DataSource, Model.InvoiceCGDetail.PRO_InvoiceAllowance, "{0:N}");
            this.xrTableHeJi.DataBindings.Add("Text", this.DataSource, Model.InvoiceCGDetail.PRO_InvoiceCGDetailMoney, "{0:N}");
            this.xrTableTax.DataBindings.Add("Text", this.DataSource, Model.InvoiceCGDetail.PRO_InvoiceCGDetailTax, "{0:N}");
            this.xrTableTaxTotal.DataBindings.Add("Text", this.DataSource, Model.InvoiceCGDetail.PRO_InvoiceCGDetailTaxMoney, "{0:N}");
