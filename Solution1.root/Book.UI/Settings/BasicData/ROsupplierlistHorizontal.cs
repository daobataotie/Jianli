...
{
    public partial class ROsupplierlistHorizontal : DevExpress.XtraReports.UI.XtraReport
    {
        public ROsupplierlistHorizontal()
        {
            InitializeComponent();
            ...
            this.TCCompanyAddress.DataBindings.Add("Text", this.DataSource, Model.Supplier.PROPERTY_COMPANYADDRESS);
        }
    }
}
