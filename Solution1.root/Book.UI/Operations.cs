...
namespace Book.UI
{
    class Operations
    {
        ...
        static Operations()
        {
            ...
            operations.Add("query.q53", (D1)delegate(System.Windows.Forms.Form form) { MM("Query.OtherCompact", new Book.UI.Query.ConditionOtherCompactChooseForm()); });
            ...
            //信息提示
            operations.Add("Book.UI.InformationForm", (D1)delegate(System.Windows.Forms.Form form) { M1("InformationForm", form); });

            //商品條碼編碼規則設定
            operations.Add("Settings.BasicData.Products.BarForm", (D1)delegate(System.Windows.Forms.Form form) { M1("Settings.BasicData.Products.BarForm", form); });
