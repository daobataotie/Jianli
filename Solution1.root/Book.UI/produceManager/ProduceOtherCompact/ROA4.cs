...
namespace Book.UI.produceManager.ProduceOtherCompact
{
    ...
    public partial class ROA4 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public ROA4(string produceOtherCompactId)
        {
            InitializeComponent();
            ...
            this.TCPro_Id.DataBindings.Add("Text", this.DataSource, "Product." + Model.Product.PRO_Id);
