...
namespace Book.DA
{
    ...
    public partial interface IInvoiceXSDetailAccessor : IEntityAccessor
    {
        ...
        IList<Model.InvoiceXSDetail> SelectbyConditionX(DateTime StartDate, DateTime EndDate, DateTime Yjri1, DateTime Yjri2, Model.Customer Customer1, Model.Customer Customer2, string XOId1, string XOId2, Model.Product Product, Model.Product Product2, string CusXOId, int OrderColumn, int OrderType, Model.Employee startEmp, Model.Employee endEmp, string FreightedCompanyId, string ConveyanceMethodId, string product_Id, string productCategoryId);
        ...
        IList<Model.InvoiceXSDetail> SelectByInvoiceXOId(string invoiceXOId);
    }
