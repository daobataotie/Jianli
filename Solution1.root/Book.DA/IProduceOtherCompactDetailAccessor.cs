...
namespace Book.DA
{
    ...
    public partial interface IProduceOtherCompactDetailAccessor : IAccessor
    {
        ...
        IList<Model.ProduceOtherCompactDetail> SelectByDateAndCondition(string StartCompactId, string EndCompactId, DateTime Startdate, DateTime EndDate, string StartSupplierId, string EndSupplierId, string StartPid, string EndPid, DateTime? StartJQ, DateTime? EndJQ, int IsClosed);
    }
