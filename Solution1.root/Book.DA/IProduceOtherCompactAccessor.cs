...
namespace Book.DA
{
    ...
    public partial interface IProduceOtherCompactAccessor : IAccessor
    {
        ...
        IList<Book.Model.ProduceOtherCompact> GetByDate(DateTime startDate, DateTime endDate, Model.Product sendProduct, string CustomerInvoiceXOId, string customerid, string supplierid, string ProduceOtherCompactId, bool? isClose);
