...
namespace Book.Model
{
    ...
    public partial class ProduceOtherCompactDetail
    {
        ...
        public string IsClosedHelp
        {
            get
            {
                if (Convert.ToBoolean(IsClose))
                    return "√";
                else
                    return "X";
            }
        ...
        public readonly static string PRO_SupplierFullName = "SupplierFullName";
        public readonly static string PRO_ProductDescription = "ProductDescription";
        public readonly static string PRO_IsClosedHelp = "IsClosedHelp";
        #endregion
    }
}
