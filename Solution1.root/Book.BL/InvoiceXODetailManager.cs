...
namespace Book.BL
{
    ...
    public partial class InvoiceXODetailManager : BaseManager
    {
        ...
        {
            return accessor.Select(customer1, customer2, startDate, endDate, yjrq1, yjrq2, employee1, employee2, xoid1, xoid2, cusxoidkey, product, product2, isclose, mpsIsClose, orderColumn, orderType, detailFlag, product_Id);
        }
