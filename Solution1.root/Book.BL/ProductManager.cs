...
namespace Book.BL
{
    ...
    public partial class ProductManager : BaseManager
    {
        ...
        BL.ProductBarCodeSetManager productBarCodeSetManager = new ProductBarCodeSetManager();
        ...
        public IList<Model.Product> SelectProductForXOByCustomer(string customerId)
        {
            return accessor.SelectProductForXOByCustomer(customerId);
        }
        ...
        /// </summary>
        /// <param name="p"></param>
        public void BarCodeRecursion(Model.Product p)
        {
            if (this.BarCodeIsExists(p))
            {
                productBarCodeSetManager.Increment();
                p.ProductBarCode = productBarCodeSetManager.RandomBarCode();
                this.BarCodeRecursion(p);
            }
        }

        public bool BarCodeIsExists(Model.Product p)
        {
            return accessor.BarCodeIsExists(p.ProductBarCode);
        }

        public Book.Model.Product SelectByBarCode(string productBarCode)
        {
        ...
        public IList<Model.Product> SelectIdAndName()
        {
