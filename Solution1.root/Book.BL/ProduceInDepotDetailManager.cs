...
namespace Book.BL
{
    ...
    public partial class ProduceInDepotDetailManager : BaseManager
    {
        ...
        public IList<Book.Model.ProduceInDepotDetail> Select(string startPronoteHeader, string endPronoteHeader, DateTime startDate, DateTime endDate, string product_Id, Model.WorkHouse work, Model.Depot mDepot, Model.DepotPosition mDepotPosition, string id1, string id2, string cusxoid, Model.Customer customer1, Model.Customer customer2, int ProductState)
        {
            return accessor.Select(startPronoteHeader, endPronoteHeader, startDate, endDate, product_Id, work, mDepot, mDepotPosition, id1, id2, cusxoid, customer1, customer2, ProductState);
        ...
        public IList<Book.Model.ProduceInDepotDetail> SelectList(string startPronoteHeader, string endPronoteHeader, DateTime startDate, DateTime endDate, string product_Id, Model.WorkHouse work, Model.Depot mDepot, Model.DepotPosition mDepotPosition, string id1, string id2, string cusxoid, Model.Customer customer1, Model.Customer customer2, int ProductState)
        {
            return accessor.SelectList(startPronoteHeader, endPronoteHeader, startDate, endDate, product_Id, work, mDepot, mDepotPosition, id1, id2, cusxoid, customer1, customer2, ProductState);
