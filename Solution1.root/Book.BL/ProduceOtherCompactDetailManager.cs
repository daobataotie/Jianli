...
namespace Book.BL
{
    ...
    public partial class ProduceOtherCompactDetailManager
    {
        ...
        {
            return accessor.SelectByDateAndCondition(StartCompactId, EndCompactId, Startdate, EndDate, StartSupplierId, EndSupplierId, StartPid, EndPid, StartJQ, EndJQ, IsClosed);
        }
    }
}
