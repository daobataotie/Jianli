        ...
        private void _Insert(Model.InvoiceXT invoice)
        {
            ...
            foreach (Model.InvoiceXTDetail detail in invoice.Details)
            {
                ...
                {                   
                    ...
                    //xodetail.InvoiceXODetailQuantity = xodetail.InvoiceXODetailQuantity - xodetail.InvoiceXODetailBeenQuantity + xodetail.InvoiceXTDetailQuantity;
                    //xodetail.InvoiceXODetailQuantity = xodetail.InvoiceXODetailQuantity < 0 ? 0 : xodetail.InvoiceXODetailQuantity;
