...
namespace Book.BL
{
    ...
    public partial class CustomerProductsManager : BaseManager
    {
        ...
        BL.ProductManager ProductManager = new ProductManager();
        ...
        public IList<Model.CustomerProducts> Select(Book.Model.Customer customer, Book.Model.Customer customer2)
        {
            return accessor.Select(customer, customer2);
        }
